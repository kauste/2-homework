                ...
                <div class="card-body">
                    <form action="{{route('colorsUpdate', $color)}}" method="post">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="color" id="color_choice" name="color_choice" value="{{old('color_choice', $color->color)}}">
                        </div>
                        <div class="form-group">
                            <label class="create-label" for="color_name">Change colors name to proper one: </label>
                            <input class="form-control" type="text" id="color_name" name="color_name" value="{{old('color_name', $color->title)}}" />
                        </div>
                        @csrf
                        @method('put')
